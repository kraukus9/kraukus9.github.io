		...
		<br>
			...
			<div class="col-xs-12 col-sm-9">
				<div class="embed-responsive embed-responsive-16by9"> 
					<iframe referrerpolicy='unsafe-url' allow='encrypted-media' width='100%' height='100%' marginwidth='0' marginheight='0' scrolling='no' frameborder='0' allowfullscreen='yes' allow="autoplay" src='/alt2.php'></iframe>
				</div>
