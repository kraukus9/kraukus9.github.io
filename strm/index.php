	...
	<div class="container-fluid">
		...
		<br>
			...
			<div class="col-xs-12 col-sm-9">
				...
				<?php
				echo '<iframe referrerpolicy="unsafe-url" allow="encrypted-media" width="100%" height="100%" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" allowfullscreen="yes" allow="autoplay" src="/strm/' . htmlspecialchars($_GET["channel"]) . '.php"></iframe>';?>
				</div>
